/*! @algolia/autocomplete-theme-classic 1.4.1 | MIT License | © Algolia, Inc. and contributors | https://github.com/algolia/autocomplete */
/* ---------------- */
/* 1.  CSS Variables */
/* 2.  Dark Mode */
/* 3.  Autocomplete */
...
.aa-ClearButton {
  ...
  height: 100%;
  margin: 0;
  padding: 0 calc(calc(16 * 1 * 1px) * (5 / 6) - 0.5px);
  padding: 0 calc(var(--aa-spacing) * (5 / 6) - 0.5px);
}
@media (hover: none) and (pointer: coarse) {
  .aa-ClearButton {
    padding: 0 calc(calc(16 * 1 * 1px) * (2 / 3) - 0.5px);
